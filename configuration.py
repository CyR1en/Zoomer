...
class ConfigNode(Enum):
    ...
    """
    LINKS = ("links", "{\"First Link\":\"https://github.com/CyR1en\", \"Second Link\":\"https://cyr1en.com\"}")
...
class ConfigFile(File, ABC):
    ...
    def get_dict_node(self, node):
        """
        Get a node with a dictionary value.
        :param node: ConfigNode with a value of dict.
        :return: Returns a dictionary that was literally evaluated.
        """
        return self._collection_literal_eval(node, '\\{.*?\\}', dict())
